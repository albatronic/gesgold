...
class EmpresasEntity extends Entity {
    ...
    protected $_parentEntities = array(
        ...
        array('SourceColumn' => 'IDEmpresa', 'ParentEntity' => 'Almacenes', 'ParentColumn' => 'IDEmpresa'),
    );
    ...
    public function getIDVersion() {
        if (!($this->IDVersion instanceof Versiones))
            $this->IDVersion = new Versiones($this->IDVersion);
