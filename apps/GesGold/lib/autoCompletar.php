...
switch ($_GET['entidad']) {
    ...
    // BUSCA CLIENTES DEL CUALQUIER SUCURSAL POR %RAZONSOCIAL% y $NOMBRECOMERCIAL%
    case 'clientes':
        $cliente = new Clientes();
        $rows = $cliente->fetchAll($_GET['term']);
        unset($cliente);
        break;
    ...
    case 'articulos':
        ...
        $filtro = "((Codigo LIKE '%{$_GET['term']}%') or (Descripcion LIKE '%{$_GET['term']}%'))";
